...
class App {
  ...
  update() {
    ...
    if (this.medias && this.medias.length > 0) {
      ...
      const width = this.medias[0].width;
      let currentIndex = Math.round(Math.abs(this.scroll.current) / width);
      ...
      if (this.activeIndex !== currentIndex) {
        ...
        if (this.onActiveIndexChange) {
           this.onActiveIndexChange(currentIndex);
        }
      }
    }
...
export default function CircularGallery({
  ...
  useEffect(() => {
    const app = new App(containerRef.current, { items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, onActiveIndexChange });
    return () => {
      app.destroy();
    };
